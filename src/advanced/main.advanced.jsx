...
// 컴포넌트
const Header = () => <h1 className="text-2xl font-bold mb-4">장바구니</h1>;
const StockInfo = () => <div className="text-sm text-gray-500 mt-2" id="stock-status">장바구니</div>;
const CartDisplay = () => <div id="cart-items"></div>;
const CartTotal = () => <div className="text-xl font-bold my-4" id="cart-total"></div>;
const ProductSelect = () => <select className="border rounded p-2 mr-2" id="product-select"></select>;
const AddButton = ({ onClick }) => <button id="add-to-cart" className="bg-blue-500 text-white px-4 py-2 rounded" onClick={onClick}>추가</button>;
const App = () => {
  return (
