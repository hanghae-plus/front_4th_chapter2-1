...
describe('basic test', () => {
  describe.each([
    { loadFile: () => import('../../main.original.js'), type: 'origin' },
    { loadFile: () => import('../main.basic.js'), type: 'basic' },
    ...
    it('포인트가 올바르게 계산되는지 확인', () => {
      sel.value = 'p2';
      addBtn.click();
      expect(document.getElementById('points').textContent).toContain('(포인트: 128)');
    });
