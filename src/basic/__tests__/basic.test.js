...
describe('basic test', () => {
  ...
  describe.each([
    ...
    it('총액이 올바르게 계산되는지 확인', () => {
      ...
      addBtn.click();
      addBtn.click();
      expect(sum.textContent).toContain(isTuesday ? '총액: 18000원(10.0% 할인 적용)(포인트: 18)' : '총액: 20000원(포인트: 20)');
    });
    ...
    it('포인트가 올바르게 계산되는지 확인', () => {
      ...
      sel.value='p2';
      addBtn.click();
      expect(document.getElementById('loyalty-points').textContent).toContain(isTuesday ? '(포인트: 115)': '(포인트: 128)');
    });
