...
import { renderToElement, scheduleInterval, calcCart, addToCartClickHandler, cartItemsClickHandler } from "./utils";
...
const main = () => {
  ...
  scheduleInterval(alertSaleEvent, 30000, 10000);
  scheduleInterval(alertLastSelEvent, 60000, 20000);
